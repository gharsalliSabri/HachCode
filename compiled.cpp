...
int main()
{
    ...
    for(int i=0;i<num_library;i++){
        c=0;
        for(int j=0;j<librarys[i].nbr_books;j++){
    ...
    for(int i=0;i<num_library;i++)
    {
        score_library_day.push_back((float) ((score_librarys[i]/librarys[i].nbr_books)*librarys[i].max_books_day));
    }
    ...
    for(int i=0;i<num_library;i++)
    {
        ...
        if(add>=librarys_order[i].nbr_books)
        num_books_library.push_back(librarys_order[i].nbr_books);
        else
